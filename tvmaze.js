...
async function searchShows(query) {
  ...
  else if(!showList[0].show.image.original){
    return [
      {
        id: showList[0].show.id,
        name: showList[0].show.name,
        summary: showList[0].show.summary,
    ...
    return [ 
      {
        ...
        name: showList[0].show.name,
        summary: showList[0].show.summary,
        image: showList[0].show.image.original
      }
    ]
  }
}
...
$("#search-form").on("submit", async function handleSearch (evt) {
  ...
  $("#episode-form").on("click", async function(evt){
    evt.preventDefault();
    $("#episodes-area").show();
  });
